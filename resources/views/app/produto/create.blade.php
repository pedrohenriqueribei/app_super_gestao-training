        ...
        <div class="informacao-pagina">
            ...
            <div style="width:30%; margin-left: auto; margin-right: auto;">
                ...
                <form action="" method="post">
                    @csrf
                    <input type="text" name="nome" id="nome" value="" placeholder="Nome" class="borda-preta">
                    <span style="color: red;">{{ $errors->has('nome') ? $errors->first('nome') : '' }}</span>

                    <input type="text" name="descricao" id="descricao"  value=""placeholder="Descrição" class="borda-preta">
                    <span style="color: red;">{{ $errors->has('descricao') ? $errors->first('descricao') : '' }}</span>

                    <input type="text" name="peso" id="peso" value="" placeholder="peso" class="borda-preta">
